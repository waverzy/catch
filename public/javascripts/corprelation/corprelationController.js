            ...
            success:function(output){
                if(output.msg == 'success')
                {
                    ...
                    for(var i=0; i<output.unrelated.length; i++) {
                        ...
                        $('#tb-unrelated').append('<tr><th style="text-align: center"><input type="checkbox" name="'+temp.name+'" value="'+temp.code + '"></th><th>'+temp.name+'</th></tr>');
                    }
                } else if (output.msg == 'logout') {
                    window.location.reload();
                } else {
            ...
            success:function(output){
                if(output.msg == 'success')
                {
                    ...
                    for(var i=0; i<output.related.length; i++) {
                        ...
                        $('#tb-related').append('<tr><th style="text-align: center"><input type="checkbox" name="'+temp.name+'" value="'+temp.code + '"></th><th>'+temp.name+'</th></tr>');
                    }
                } else if (output.msg == 'logout') {
                    window.location.reload();
                } else {
